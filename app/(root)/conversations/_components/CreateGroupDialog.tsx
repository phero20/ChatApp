  ...
  return (
    <Dialog>
      ...
      <DialogContent className="block">
        <DialogHeader className="w-full flex items-center pb-2">
          <DialogTitle>Create Group</DialogTitle>
          <DialogDescription>
            Add yours friends to get started!
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
          ...
          >
            ...
            {members && members.length ? (
              <Card className="flex-row items-center gap-6 overflow-x-auto w-full h-24 p-4 no-scrollbar">
                {friends
                      ...
                      >
                        <div className="relative">
                          ...
                          <X
                            ...
                            className="text-muted-foreground w-4 h-4 absolute bottom-5 left-5 bg-muted rounded-full cursor-pointer"
                          />
                        </div>
